  ...
  },
  {
    ...
    contentKaz: `
      <div class="archive-section">
        ...
        <p class="archive-text">
          Бүгінде ұрпақтары оның ағартушылық мұрасын мақтанышпен жалғастырып келеді.
        </p>
        ...
        <div class="shezhire-tree">
          <h4 class="shezhire-title">🌳 Көбеевтер әулетінің шежіресі</h4>
          <div class="tree-container">
            <div class="tree-node">
              <div class="node-title">Көбей ата</div>
              <div class="node-sub">Ауыл ақсақалы, еңбекқор әулет басы</div>
            </div>
            <div class="tree-line"></div>
            <div class="tree-node main">
              <div class="node-title">Спандияр Көбеев (1878–1956)</div>
              <div class="node-sub">Ұлт ағартушысы, ұстаз, қаламгер</div>
            </div>
            <div class="tree-line"></div>
            <div class="tree-node">
              <div class="node-title">Балалары мен ұрпақтары</div>
              <div class="node-sub">Ғалымдар, дәрігерлер, мұғалімдер</div>
            </div>
          </div>
        </div>
      </div>
    ...
    contentRu: `
      <div class="archive-section">
        ...
        <p class="archive-text">
          Спандияр Көбеев был главой дружной и образованной семьи. Вместе с супругой <strong>Кульзипой</strong> они воспитали детей в традициях уважения к науке и труду.
        </p>
        ...
        <div class="shezhire-tree">
          <h4 class="shezhire-title">🌳 Шежіре семьи Көбеевых</h4>
          <div class="tree-container">
            <div class="tree-node">
              <div class="node-title">Көбей ата</div>
              <div class="node-sub">Основатель рода, степной труженик</div>
            </div>
            <div class="tree-line"></div>
            <div class="tree-node main">
              <div class="node-title">Спандияр Көбеев (1878–1956)</div>
            ...
            <div class="tree-line"></div>
            <div class="tree-node">
              <div class="node-title">Дети и потомки</div>
              <div class="node-sub">Педагоги, ученые, врачи</div>
            </div>
          </div>
        </div>
      </div>
