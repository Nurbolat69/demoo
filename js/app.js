...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Road Curve Key Points in Viewport Percentages matching landmarks in authentic Aksuat landscape
  const naturalRoadControlPoints = [
    { x: 6, y: 34 },
    { x: 13, y: 38 }, // Station 1: Lake Aksuat horizon & peaceful steppe
    { x: 20, y: 48 },
    { x: 28, y: 61 }, // Station 2: Steppe road
    { x: 27, y: 70 },
    { x: 33, y: 76 },
    { x: 42, y: 78 }, // Station 3: Steppe crossroads
    { x: 50, y: 68 },
    { x: 56, y: 57 }, // Station 4: Village rural school cottage
    { x: 65, y: 60 },
    { x: 73, y: 63 }, // Station 5: Village center under green trees
    { x: 81, y: 58 },
    { x: 89, y: 56 }, // Station 6: Spandiyar's homestead
    { x: 96, y: 55 }
  ];
